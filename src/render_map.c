...
/*   Updated: 2025/09/28 16:09:47 by fio              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    load_assets(t_game *game)
{
    ...
    game->ground_img = mlx_xpm_file_to_image(game->mlx, "assets/ground.xpm", &w, &h);
    game->item_img = mlx_xpm_file_to_image(game->mlx, "assets/item.xpm", &w, &h);
